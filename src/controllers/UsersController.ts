...
export default class UsersController {
    ...
    updateProfile(profile: ChnageUserProfileRequest, oldPassword: any, newPassword: any, avatar: File | null) {
    ...
    private updatePassword(oldPassword: any, newPassword: any) {
        return this._userAPI.updatePassword(oldPassword, newPassword);
    }

    private updateAvatar(avatar: any) {
